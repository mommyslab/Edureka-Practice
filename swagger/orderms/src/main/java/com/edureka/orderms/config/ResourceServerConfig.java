...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        /*http.requestMatchers()
                ...
                .antMatchers(HttpMethod.GET, "/orders/**").access("#oauth2.hasScope('read')")
                .antMatchers(HttpMethod.POST, "/orders/**").access("#oauth2.hasScope('write')")
                .antMatchers(HttpMethod.DELETE, "/orders/**").access("#oauth2.hasScope('write')");
